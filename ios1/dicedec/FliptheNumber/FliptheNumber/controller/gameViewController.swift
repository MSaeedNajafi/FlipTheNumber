...
class gameViewController: BaseViewController {
    ...
    @IBOutlet weak var dollarwnnnwerlbl: UILabel!
    ...
    override func viewDidLoad() {
        ...
        if value == "1"
        {
            ...
            //               user_image.clipsToBounds = true
            dollarwnnnwerlbl.text! = ((data?.value(forKey: "total_token") ?? 0 )  as AnyObject).description
        ...
        else
        {
            ...
            dollarwnnnwerlbl.text = (UserDefaults.standard.value(forKey: "total_token") ?? 0 ) as? String
