...
//  Bunavid
//
//  Created by Murteza on 30/12/2019.
...
fileprivate static let activityIndicator = NVActivityIndicatorView(frame: CGRect(x: 0, y: 0, width: 60, height: 60) , type: .ballClipRotatePulse, color: .systemPink, padding: 10)
...
super.init()
ActivityIndicator.overlayView.backgroundColor = UIColor(displayP3Red: 0/256, green: 122/256, blue: 255/256, alpha: 1.0).withAlphaComponent(0.3)
}

func showLoadingIndicator(text: String?, type: NVActivityIndicatorType = .circleStrokeSpin, color: UIColor = UIColor(displayP3Red: 0/256, green: 122/256, blue: 255/256, alpha: 1.0)) {
