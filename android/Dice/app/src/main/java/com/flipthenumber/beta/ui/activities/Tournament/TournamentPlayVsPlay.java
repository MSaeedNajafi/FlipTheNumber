package com.flipthenumber.beta.ui.activities.Tournament;
...
public class TournamentPlayVsPlay extends AppCompatActivity implements View.OnClickListener {
    ...
    private String round,tournament_id;
    ...
    private void init() {
        ...
        isMusic = SharedHelper.getBooleanKey(TournamentPlayVsPlay.this, UserConstant.isMusic);
        isSound = SharedHelper.getBooleanKey(TournamentPlayVsPlay.this, UserConstant.isSound);
        ...
        zokar_txt.setText(SharedHelper.getKey(TournamentPlayVsPlay.this, UserConstant.zokar));
        ttxt.setText(SharedHelper.getKey(TournamentPlayVsPlay.this, UserConstant.point));
        total_coin_txt.setText(SharedHelper.getKey(TournamentPlayVsPlay.this, UserConstant.coin));
        ttxt_two.setText(SharedHelper.getKey(TournamentPlayVsPlay.this, UserConstant.coin));
        ...
        builder = new AlertDialog.Builder(TournamentPlayVsPlay.this);
    ...
    private void initUI()
    {
       ...
       // sb.setCharAt(0, Character.toUpperCase(sb.charAt(0)));
        ...
        layout_dice_movement.setOnClickListener(new TournamentPlayVsPlay.HandleClick());

        nameTxt.setText(SharedHelper.getKey(TournamentPlayVsPlay.this, UserConstant.name));
        ...
        if(!round.equalsIgnoreCase("final")){
            int round_=Integer.parseInt(round)-1;
            round=String.valueOf(round_);
        }

        Log.i("RoundIsHere",round);


        tournament_id=getIntent().getStringExtra("tournament_id");

        unique_id=getIntent().getStringExtra("user_id_player_id");
        Log.i("uniqueId",unique_id);
            ...
            if (userid.equals("")) {
                ...
                if (getIntent().getStringExtra("turn").equals("your")) {
                    ...
                    if(count_for_no_combination==1){
                        ...
                        try {
                            timer.schedule(new TournamentPlayVsPlay.RollThree(), 1100);
                        } catch (Exception e) {
                        ...
                        dice2_picture.startAnimation(rotate);
                        try {
                            timer.schedule(new TournamentPlayVsPlay.Roll(), 1100);
                        } catch (Exception e) {
                    ...
                    public void run() {
                        ...
                        if (arrayListFilterData.size() > 0) {
                            ...
                            if(zokar_txt.getText().toString().trim().equals("0")){
                                ...
                                final Dialog dialog = new Dialog(TournamentPlayVsPlay.this);
...
//        });
    ...
    private void showChatDialog() {
        ...
        Dialog dialog = new Dialog(TournamentPlayVsPlay.this);
        dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
    ...
    private void apiCallSendMsg(String msg,RecyclerView recyclerView,NestedScrollView nestedScrollView) {
        ...
        ProgressDialog dialog=new ProgressDialog(TournamentPlayVsPlay.this);
                            ...
                            try {
...

                                {
                                    ...
                                    if (i == 0) {
                                        ...
                                        if(round.equalsIgnoreCase("final")){
                                            ApiInterface apiInterface = AppConfig.getRetrofit().create(ApiInterface.class);
                                            Call<ModelAddCoins> call = apiInterface.tournamentfinalprice("Bearer "+token,tournament_id,SharedHelper.getKey(getApplicationContext(),UserConstant.id));
                                            ...
                                            ApiInterface apiInterface = AppConfig.getRetrofit().create(ApiInterface.class);
                                            Call<ModelAddCoins> call = apiInterface.roundwinner("Bearer "+token,SharedHelper.getKey(getApplicationContext(),UserConstant.id),user_two_id,round,tournament_id);
                                            call.enqueue(new Callback<ModelAddCoins>() {
                                                @Override
                                                public void onResponse(Call<ModelAddCoins> call, Response<ModelAddCoins> response) {
                                                                        ...
                                                                        if (txt_seven.getCurrentTextColor() == getResources().getColor(R.color.colorPrimaryDark) || txt_seven.getCurrentTextColor() == getResources().getColor(R.color.coloryellow) || txt_seven.getCurrentTextColor() == getResources().getColor(R.color.colorsolidGreen) || txt_seven.getCurrentTextColor() == getResources().getColor(R.color.colorsDarkSky) || txt_seven.getCurrentTextColor() == getResources().getColor(R.color.colorRedLightNew)) {
                                                                            if (txt_eight.getCurrentTextColor() == getResources().getColor(R.color.colorPrimaryDark) || txt_eight.getCurrentTextColor() == getResources().getColor(R.color.coloryellow) || txt_eight.getCurrentTextColor() == getResources().getColor(R.color.colorsolidGreen) || txt_eight.getCurrentTextColor() == getResources().getColor(R.color.colorsDarkSky) || txt_eight.getCurrentTextColor() == getResources().getColor(R.color.colorRedLightNew)) {
                                                                                if (txt_nine.getCurrentTextColor() == getResources().getColor(R.color.colorPrimaryDark) || txt_nine.getCurrentTextColor() == getResources().getColor(R.color.coloryellow) || txt_nine.getCurrentTextColor() == getResources().getColor(R.color.colorsolidGreen) || txt_nine.getCurrentTextColor() == getResources().getColor(R.color.colorsDarkSky) || txt_nine.getCurrentTextColor() == getResources().getColor(R.color.colorRedLightNew)) {
                                                                                    ...
                                                                                    if(round.equalsIgnoreCase("final")){
                                                                                        ApiInterface apiInterface = AppConfig.getRetrofit().create(ApiInterface.class);
                                                                                        Call<ModelAddCoins> call = apiInterface.tournamentfinalprice("Bearer "+token,tournament_id,user_two_id);
                                                                                        call.enqueue(new Callback<ModelAddCoins>() {
                                                                                            @Override
                                                                                            public void onResponse(Call<ModelAddCoins> call, Response<ModelAddCoins> response) {
                                                                                        ...
                                                                                        ApiInterface apiInterface = AppConfig.getRetrofit().create(ApiInterface.class);
                                                                                        Call<ModelAddCoins> call = apiInterface.roundwinner("Bearer "+token,user_two_id,SharedHelper.getKey(getApplicationContext(),UserConstant.id),round,tournament_id);
                                                                                        call.enqueue(new Callback<ModelAddCoins>() {
                                                                                            @Override
                                                                                            public void onResponse(Call<ModelAddCoins> call, Response<ModelAddCoins> response) {
            ...
            public void onResponse(Call<ModelReUseJoker> call, Response<ModelReUseJoker> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (response.body().getStatus()) {
                        ...
                        SharedHelper.putKey(TournamentPlayVsPlay.this,UserConstant.zokar,response.body().getData().get(0).getTotal_zoker());
                        ...
                        dice2_picture.startAnimation(rotate);
                        try {
                            timer.schedule(new TournamentPlayVsPlay.RollTwo(), 1100);
                        } catch (Exception e) {
            ...
            public void onResponse(Call<ModelReUseJoker> call, Response<ModelReUseJoker> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (response.body().getStatus()) {
                        ...
                        dice2_picture.startAnimation(rotate);
                        try {
                            timer.schedule(new TournamentPlayVsPlay.RollFour(), 1100);
                        } catch (Exception e) {
    ...
    private void methodNOJoker() {
        final Dialog dialog = new Dialog(TournamentPlayVsPlay.this);
        dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
        dialog.setContentView(R.layout.dialog_if_not_joker);
    ...
    private void apiCallCounterForAds() {
        ...
        ApiInterface apiInterface = AppConfig.getRetrofit().create(ApiInterface.class);
        Call<GamePageCounterModel> call = apiInterface.gamepagecounter("Bearer "+token,SharedHelper.getKey(TournamentPlayVsPlay.this, UserConstant.id));
