...
public class FragmentUntilRoundStart extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_until_round_start, container, false);
        Init();
        InitUI();
        return view;
